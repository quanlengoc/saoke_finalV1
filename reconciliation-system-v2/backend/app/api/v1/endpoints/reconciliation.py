...
def _build_matching_config(config: PartnerServiceConfig) -> dict:
    ...
    return {
        "b1_b4": parse_json(getattr(config, 'matching_rules_b1b4', None)),
        "b1_b2": parse_json(getattr(config, 'matching_rules_b1b2', None)),
        "a1_b3": parse_json(getattr(config, 'matching_rules_b3a1', None)),
        "status_combine": parse_json(getattr(config, 'status_combine_rules', None)),
        "output_columns": parse_json(getattr(config, 'output_a1_config', None)),
        "a2_output": parse_json(getattr(config, 'output_a2_config', None)),
    }
