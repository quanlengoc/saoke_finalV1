"""
Partners and services endpoints
...
async def list_partners_services(
    ...
    if current_user.is_admin:
        # Admin sees all active partners/services
        configs = db.query(
    ...
    for perm in permissions:
        if isinstance(perm, dict):
            ...
            # Get partner/service names from config
...
async def get_config_for_date(
    ...
    return {
        ...
        "has_b2": config.file_b2_config is not None,
        "has_b3": config.file_b3_config is not None,
