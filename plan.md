...
Hệ thống đối soát tự động giữa dữ liệu B4 (nội bộ) và PARTNER (đối tác) cho các dịch vụ:
...
Đối soát giao dịch giữa hệ thống nội bộ (B4) và sao kê từ đối tác (Partner) nhằm:
- Phát hiện giao dịch **khớp** giữa 2 bên
- Phát hiện giao dịch **chỉ có ở B4** (B4 ghi nhận nhưng Partner không có)
- Phát hiện giao dịch **chỉ có ở Partner** (Partner ghi nhận nhưng B4 không có)
- Phát hiện giao dịch **lệch số tiền** hoặc **lệch số lượng**
